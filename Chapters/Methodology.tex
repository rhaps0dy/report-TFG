...
contains enough information to satisfy the Markov property (\ffref{subsec:MDP}).
...
(\ffref{sec:score-montezuma-revenge}).
\begin{figure}[hbtp]
\begin{center}
...
\subsection{Improving performance with domain knowledge}
