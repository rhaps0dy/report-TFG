...
\fxwarning{Expand or erase, depending on what is necessary}
...
true when all actions have the same cost. Its space and time complexity are $O(b^d)$
...
\subsection{Planning and \acl{IW}}
...
also the novelty measure example in \ffref{tab:novelty-example}.
...
\citet{lipovetzky2012width} define the \newconcept{width} $w$ of a planning problem
